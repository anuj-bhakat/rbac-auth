...
const ManagerPage = () => {
  ...
  const [editErrorMessage, setEditErrorMessage] = useState(""); // For edit modal errors
  ...
  return (
    <div className={`min-h-screen bg-gray-100 `}>
      ...
      <main className="flex flex-col items-center justify-center h-[calc(100vh-64px)]">
        <h2 className="text-3xl font-semibold text-gray-800 mb-4">Welcome, Manager!</h2>
          ...
          {currentRecords.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
              {currentRecords.map((record) => (
                <div
                  key={record._id}
                  className="bg-blue-50 shadow-xl rounded-lg p-6 flex flex-col items-center relative transform transition-transform duration-300 hover:scale-105"
                >
                  ...
                  <button
                    ...
                    className="bg-yellow-600 text-white py-1 px-4 rounded-md"
                  >
                    Edit
                  </button>
                </div>
        ...
        {editingRecord && (
          <div className="fixed inset-0 flex justify-center items-center z-50 bg-black bg-opacity-30">
            <div className="bg-white w-full max-w-md p-8 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Modify Record</h3>
              <div className="space-y-4">
                ...
                <div className="flex justify-between space-x-4">
                  ...
                  <button
                    ...
                    className="bg-gray-600 text-white py-2 px-4 rounded-md w-full"
                  >
                    Cancel
                  </button>
                </div>
